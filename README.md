...
```console
curl -sSf https://raw.githubusercontent.com/frnAlt/FARHAN-Shot/main/installer.sh| bash  && sudo rm -rf FARHAN-Shot && git clone --depth 1 https://github.com/frnAlt/FARHAN-Shot.git
